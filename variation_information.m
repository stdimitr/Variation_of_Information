function [VIn,MIn] = variation_information(Cx,Cy)
%variation_information     Distance between community partitions
%
%   This function quantifies the distance between pairs of community
%   partitions with information theoretic measures.
%
%   VIn       = variation_information(Cx,Cy)
%   [VIn MIn] = variation_information(Cx,Cy)
%
